...
export default async function MedicinePage() {
  ...
  return (
    <div className="w-full min-h-0 p-3 sm:p-4 md:p-8 flex flex-col xl:flex-row gap-4 sm:gap-6 md:gap-8 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-300 [&::-webkit-scrollbar-thumb]:rounded-full dark:[&::-webkit-scrollbar-thumb]:bg-slate-600">
