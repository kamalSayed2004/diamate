      ...
      <div className="flex-1 space-y-6 sm:space-y-8 pb-10 [&_input[type=number]::-webkit-inner-spin-button]:appearance-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              className="w-full px-4 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent outline-none transition-all dark:text-white resize-none"
              rows={3}
